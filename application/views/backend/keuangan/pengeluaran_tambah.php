    ...
    <div class="box-body">
      <div class="row mt-6">
        <div class="col-md-4 col md-ofset-4">
          <?php echo form_open_multipart('keuangan/tambahDataPengeluaran'); ?>
          <div class="form-group">
            <label>Keterangan*</label>
            <input class="form-control" type="text" id="keterangan" name="keterangan" value="<?= set_value('keterangan'); ?>">
          ...
          <div class="input-group flex-nowrap">
            ...
            <input type="text" class="form-control" id="nominal_keluar" name="nominal_keluar" placeholder="ex : 150000" aria-label="nominal_keluar" aria-describedby="addon-wrapping" value="<?= set_value('nominal_keluar'); ?>">
          </div>
